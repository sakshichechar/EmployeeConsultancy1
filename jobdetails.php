    ...
    <div class="container mt-5">
        <div class="bg">
            ...
            <form method="post" action="jobquery.php">
                ...
                <div class="form-group">
                    <label for="field4">No of Vacancy</label>
                    <input type="text" class="form-control" name="field4" id="field4" required>
                </div>
                <div class="form-group">
                    <label for="field3">Salary</label>
                    <input type="text" class="form-control" name="field3" id="field3" required>
                </div>
